            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800">{{ Auth::user()->unidad }}</span>
                            </div>
                        </div>
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 d-flex align-items-center">
                                <span class="fw-bold fs-6 text-gray-800 me-2">{{ Auth::user()->extension }}</span>
                            </div>
                        </div>
                        ...
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-semibold text-muted">Estatus</label>
                            <div class="col-lg-8">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-body border-top p-9">
                        <form id="kt_profile_change_password_form" class="form" method="POST"
                            ...
                            <div class="row mb-6 fv-row">
                                <label class="col-lg-4 col-form-label required fw-semibold fs-6">Confirmar
                                    contraseña</label>
                                <div class="col-lg-8">
